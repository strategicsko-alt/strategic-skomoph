...
- **ระบบเพิ่มและแก้ไขตัวชี้วัด HDC:** สามารถสร้างตัวชี้วัดใหม่ หรือแก้ไขตัวชี้วัดที่มีอยู่เดิม (เปลี่ยนชื่อ, ชื่อตาราง, ปีงบประมาณ, เกณฑ์เป้าหมาย และเกณฑ์เตือนภัย) พร้อมดึงข้อมูลสดใหม่ทันที
- **การแสดงผลแท็กปีงบประมาณ:** มี Badge แสดงปีงบประมาณกำกับในหัวคอลัมน์ของทุกตัวชี้วัดอย่างชัดเจน (เช่น `[HDC-01] 📅 ปี 2569 (s_anc5)`)
